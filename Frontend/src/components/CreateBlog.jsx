...
//                     : "border-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-blue-500 dark:focus:ring-blue-400"
//                 } focus:outline-none focus:ring-2 focus:ring-opacity-50 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-colors duration-200`}
//               />
//               <div className="absolute right-3 top-3 text-xs text-gray-500 dark:text-gray-400">
//                 {titleCharCount}/{maxTitleLength}
//               </div>
...
//                 accept="image/*"
//                 onChange={(e) => setFile(e.target.files[0])}
//                 className="w-full px-4 py-3 pl-10 rounded-lg border border-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-blue-500 dark:focus:ring-blue-400 focus:outline-none focus:ring-2 focus:ring-opacity-50 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-colors duration-200 file:mr-4 file:py-1 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-medium file:bg-blue-50 dark:file:bg-gray-700 file:text-blue-700 dark:file:text-blue-400 hover:file:bg-blue-100 dark:hover:file:bg-gray-600"
//               />
//               <span className="absolute left-3 top-3.5 text-gray-500 dark:text-gray-400">
//                 {icons.Image}
//               </span>
...
//                     ? "border-red-500 dark:border-red-400 focus:border-red-500 dark:focus:border-red-400 focus:ring-red-500 dark:focus:ring-red-400"
//                     : "border-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-blue-500 dark:focus:ring-blue-400"
//                 } focus:outline-none focus:ring-2 focus:ring-opacity-50 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 disabled:bg-gray-100 dark:disabled:bg-gray-700 disabled:cursor-not-allowed transition-colors duration-200`}
//               />
//               <span className="absolute left-3 top-3.5 text-gray-500 dark:text-gray-400">
//                 {icons.Tag}
//               </span>
...
//               {/* Tag Suggestions */}
//               {showTagSuggestions && filteredTags.length > 0 && (
//                 <div className="absolute z-40 w-full mt-1 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg max-h-48 overflow-y-auto">
//                   {filteredTags.slice(0, 10).map((tag) => (
//                     <button
//                       key={tag}
//                       type="button"
...
//             <div
//               className="rounded-lg overflow-hidden border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 transition-colors duration-200"
//               data-color-mode="auto"
//             >
//               <div className="dark:[&_.w-md-editor]:bg-gray-800 dark:[&_.w-md-editor-text]:bg-gray-800 dark:[&_.w-md-editor-text]:text-white dark:[&_.w-md-editor-text]:border-gray-600 dark:[&_.w-md-editor-toolbar]:bg-gray-700 dark:[&_.w-md-editor-toolbar]:border-gray-600 dark:[&_.w-md-editor-toolbar_button]:text-gray-300 dark:[&_.w-md-editor-toolbar_button]:hover:bg-gray-600 [&_.w-md-editor]:transition-colors [&_.w-md-editor]:duration-200">
//                 <MDEditor
//                   value={formData.blogBody}
//                   onChange={(value) =>
//                     handleInputChange("blogBody", value || "")
//                   }
//                   preview="edit"
//                   height={400}
//                   data-color-mode="auto"
...
//           {/* Submit Button */}
//           <div className="flex items-center justify-end space-x-4 pt-6 border-t border-gray-300 dark:border-gray-600">
//             {errors.submit && (
//               <p className="text-sm text-red-600 dark:text-red-400 flex items-center">
//                 <span className="mr-1">{icons.AlertCircle}</span>
//                 {errors.submit}
...
//             <button
//               type="button"
//               className="px-6 py-3 text-sm font-medium text-gray-900 dark:text-white bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200"
//             >
//               Save as Draft
//             </button>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="rounded-lg overflow-hidden border border-gray-300 dark:border-gray-600 transition-colors duration-200">
              <MDEditor
                value={formData.blogBody}
                onChange={(value) => handleInputChange("blogBody", value || "")}
                preview="edit"
